const BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://meupj-api-student.delightfulwave-8b9abc5f.brazilsouth.azurecontainerapps.io';export type TransactionType = 'income' | 'expense';
