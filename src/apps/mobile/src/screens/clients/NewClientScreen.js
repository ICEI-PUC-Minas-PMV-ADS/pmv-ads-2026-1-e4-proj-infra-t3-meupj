    ...
    <SafeAreaView style={styles.wrapper} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.form} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.row}>
          ...
          >
            <Text style={form.type === 'individual' ? styles.typeTextActive : styles.typeText}>
              Pessoa Física
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={form.type === 'company' ? styles.typeTextActive : styles.typeText}>
              Pessoa Jurídica
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.originRow}>
          {ORIGIN_OPTIONS.filter((o) => o.value).map((o) => (
            ...
            >
              <Text style={form.origin === o.value ? styles.originTextActive : styles.originText}>
                {o.label}
              </Text>
            </TouchableOpacity>
          ))}
